...
const Padayon = () => {
  ...
  const desc =
    "This was a project my partner and I built for our Software Development class last December 2023 and the first full-stack website I created with React TypeScript. I am particularly proud of this as I was able to pull its features off despite being new to React at the time. I had just been watching tutorials and emulating them on the website. I created the entire frontend and backend, including the database design, while my partner touched on some of the designs and created the entire documentation. I tried to deploy the website but realized it was a lot more complicated than I thought, so I tried recreating the website with better UI using MERN (MongoDB, Express.js, React TS, and Node). While I was able to successfully deploy it thanks to the tutorials, it was far from finished, and I do not have any plans on finishing it yet as I realized how big the project was for one person.";
